  ...
  pl: {
    translation: {
      ...
      panel: {
        ...
        chartInterval: 'Interwał',
        intervalDaily: 'Dzień',
        intervalWeekly: 'Tydzień',
        intervalMonthly: 'Miesiąc',
        chartExpand: 'Powiększ wykres',
        chartCollapse: 'Zwiń wykres',
        chartPopupAria: 'Powiększony wykres ceny',
  ...
  en: {
    translation: {
      ...
      panel: {
        ...
        chartCollapse: 'Shrink chart',
        chartPopupAria: 'Expanded price chart',
